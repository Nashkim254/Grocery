    ...
    return Material(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding:
              widget.contentPadding ?? EdgeInsets.symmetric(vertical: 12, horizontal: 20),
          ...
          disabledBorder: OutlineInputBorder(
              borderSide: BorderSide(color: Colors.grey.withOpacity(0), width: 0.0),
              borderRadius: BorderRadius.circular(widget.borderRound ?? 10)),
          ...
          enabledBorder: widget.enabledBorder ??
              OutlineInputBorder(
                  borderSide: BorderSide(
                      color: widget.enabledBorder == null ? Colors.transparent : Colors.grey[300]!,
                      width: 0.0),
                  borderRadius: BorderRadius.circular(widget.borderRound ?? 10)),
          focusedBorder: widget.focusedBorder ??
              OutlineInputBorder(
                borderSide: BorderSide(
                    color: widget.focusedBorderColor ?? Theme.of(context).primaryColor, width: 1.0),
                borderRadius: BorderRadius.circular(widget.borderRound ?? 10),
              ),
        ),
